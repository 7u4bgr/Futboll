...
import ManchesterU from "../../assets/images/ningbig.png";
          ...
          <div className={styles.control}>
            <div className={styles.text}>
              ...
              <div className={styles.backarrow}>
                <h2 className={styles.text1}>Match</h2>
                <h2 className={styles.text2}>Overview</h2>
              </div>
              <span></span>
            </div>
        ...
        <div className={styles.videocontrol}>
          {video ? (
            <iframe
              width="100%"
              height="200"
              src="https://www.youtube.com/embed/hTuYxKiVM1Y?si=bqZYVtsneb7O5fMY" 
